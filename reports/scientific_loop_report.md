...
## Top Hypotheses
- H006: Thalamus-DMN connectivity association with insomnia severity (score=0.907)
- H004: Spindle density association with thalamocortical coupling (score=0.882)
- H003: Slow-wave density association with insomnia severity (score=0.8584)
- H005: Thalamic radiation FA association with slow-wave density (score=0.846)
- H002: INS vs HC beta power difference (score=0.84)
