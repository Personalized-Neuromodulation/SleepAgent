...
- 关联实验已完成，但结果对原创新点形成了约束：静息态功能连接结果：平均相关 r=0.1835，平均绝对相关 |r|=0.2211，最大绝对相关=0.8439，正相关边 53 条、负相关边 13 条，总边数 66 条。同时，region_labels 未发现小脑 ROI，因此原创新点中的“小脑连接”部分当前不可检验，应从本轮结论中移除或标记为待补充。 结果文件：/home/qlp/Agent_skills/neuroscience_research_agent/outputs/20260622_180947/experiments/innovation_01/resting_state_functional_connectivity_result.json。
...
- 关联实验已完成，并产生了可用于修正创新点的量化摘要：动态功能连接指标 mean_window_abs_r=0.2573。 动态功能连接指标 dynamic_variability=0.1429。 结果文件：/home/qlp/Agent_skills/neuroscience_research_agent/outputs/20260622_180947/experiments/innovation_02/dynamic_functional_connectivity_result.json。
...
- 关联实验已完成，并产生了可用于修正创新点的量化摘要：alff_falff_frequency 执行状态为 completed。 结果文件：/home/qlp/Agent_skills/neuroscience_research_agent/outputs/20260622_180947/experiments/innovation_03/alff_falff_frequency_result.json。
...
- 关联实验已完成，并产生了可用于修正创新点的量化摘要：sleep_stage_analysis 执行状态为 completed。 结果文件：/home/qlp/Agent_skills/neuroscience_research_agent/outputs/20260622_180947/experiments/innovation_05/sleep_stage_analysis_result.json。
...
- 关联实验已完成，并产生了可用于修正创新点的量化摘要：关联 result.json 未提供足够的量化指标。 结果文件：/home/qlp/Agent_skills/neuroscience_research_agent/outputs/20260622_180947/experiments/innovation_06/graph_theory_connectomics_result.json。
...
- 关联实验已完成，并产生了可用于修正创新点的量化摘要：behavioral_computational_modeling 执行状态为 completed。 结果文件：/home/qlp/Agent_skills/neuroscience_research_agent/outputs/20260622_180947/experiments/innovation_07/behavioral_computational_modeling_result.json。
...
- 关联实验已完成，并产生了可用于修正创新点的量化摘要：structural_morphometry 执行状态为 completed。 结果文件：/home/qlp/Agent_skills/neuroscience_research_agent/outputs/20260622_180947/experiments/innovation_08/structural_morphometry_result.json。

## 实验结果整体反向更新

已根据真实 result.json 指标和 ROI 覆盖情况补齐反向更新。
