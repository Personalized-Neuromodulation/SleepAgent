...
from sleep_ai_scientist.llm.client import ChatLLMClient, LLMError, LLMResponse
...
class ExperimentLLMClient:
    """Experiment-facing adapter around the shared chat LLM client."""
    ...
    def __init__(self, config: dict[str, Any], *, task_name: str) -> None:
        ...
        self.client = ChatLLMClient(llm_config)
