...
def _paper_row(paper: Paper) -> dict[str, Any]:
    return {
        ...
        "canonical_paper_id": paper.canonical_paper_id or paper.paper_id,
        "title": paper.title,
        "title_normalized": paper.title_normalized or "",
        "title_hash": paper.title_hash or "",
        ...
        "crossref_id": paper.crossref_id or "",
        "journal": paper.journal or "",
        "journal_normalized": paper.journal_normalized or "",
        ...
        "citation_sources": _json_string(paper.citation_sources_json or []),
        ...
        "journal_priority_score": paper.journal_priority_score if paper.journal_priority_score is not None else "",
        "journal_domain": _json_string(paper.journal_domain_json or []),
        "jcr_categories": _json_string(paper.jcr_categories_json or []),
        "retrieval_channels": _json_string(paper.retrieval_channels_json or []),
        "source_providers": _json_string(paper.source_providers_json or []),
        "duplicate_group_id": paper.duplicate_group_id or "",
        "merged_from": _json_string(paper.merged_from_json or []),
        "url": paper.url or "",
