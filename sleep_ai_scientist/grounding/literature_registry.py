...
def merge_literature_registry(api_records: list[LiteratureRecord]) -> tuple[list[LiteratureRecord], list[dict[str, Any]]]:
    """Merge online API literature records by DOI, PMID, normalized title, or paper id."""
