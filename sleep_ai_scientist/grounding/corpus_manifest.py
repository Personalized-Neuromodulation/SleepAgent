...
def build_corpus_manifest(
    ...
    return {
        ...
        "providers": providers,
        "api_literature_csv": str(config_path(config, "api_literature_csv", api_cfg.get("output", {}).get("api_literature_csv", "outputs/grounding/api_retrieved_papers.csv"))),
        "final_literature_registry": str(config_path(config, "literature_registry_csv", "outputs/grounding/grounding_literature_registry.csv")),
