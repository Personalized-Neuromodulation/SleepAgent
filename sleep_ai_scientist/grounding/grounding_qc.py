...
def run_grounding_qc(
    ...
    if len(evidence) < 50:
        ...
        recommended_next_steps.append("Inspect extraction rules and seed/API literature coverage.")
    if gaps:
        warnings.append("preferred mechanism coverage gaps detected")
        recommended_next_steps.append("Add targeted queries or seed papers for mechanisms listed in check_mechanism_coverage.gaps.")
