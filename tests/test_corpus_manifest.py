...
def test_build_corpus_manifest_contains_version_and_paths():
    ...
    config["query_set"] = {"version": "sleep_literature_queries_v2_broad_sleep_science"}
    ...
    assert manifest["query_set_version"] == "sleep_literature_queries_v2_broad_sleep_science"
